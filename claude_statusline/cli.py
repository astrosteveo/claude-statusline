...
commands
  segments [name] [--json]        the catalog: every segment, its options, fields and colours
...
def cmd_segments(name=None, as_json=False) -> str:
    if name:
...
def main(argv=None) -> int:
    ...
    if args.cmd == "help":
        ...
        print(cmd_segments(args.name, args.json))
